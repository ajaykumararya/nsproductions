<section class="contact-sec sec-pad" style="margin:0;margin-bottom:25px">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <div class="contact-detail">
          ...
          <ul class="contact-ul">
            <li><i class="fa fa-location-dot"></i> Near Ladnu Puliya, Kuchaman Bypass Road, Didwana  ( Pincode-341303)</li>

            <li>
              <i class="fa fa-phone"></i>
              <a href="tel:9983391818"><b>9983391818</b></a>,
              <a href="tel:7665391818"><b>7665391818</b></a>
            </li>

            <li>
              <i class="fa-solid fa-envelope"></i>
              <a href="mailto:rankerstesthub@gmail.com"><b> rankerstesthub@gmail.com</b></a>
            </li>
          </ul>
